...
class ProformaSchedule(BaseModel):
    ...
    vessel_service_lane_code = models.CharField(max_length=10, verbose_name="Vessel Service Lane Code")
    ...
    def __str__(self):
        return f"{self.vessel_service_lane_code} - {self.proforma_name} - {self.direction}- {self.port_code}"
...
class VesselInfo(BaseModel):
    ...
    contract_actual_delivery_date = models.DateTimeField(null=True, blank=True,
                                                         verbose_name="Contract Actual Delivery Date")
    delivery_max_date = models.DateTimeField(null=True, blank=True, verbose_name="Delivery Max Date")
    contract_actual_redelivery_date = models.DateTimeField(null=True, blank=True,
                                                           verbose_name="Contract Actual Redelivery Date")
    redelivery_max_date = models.DateTimeField(null=True, blank=True, verbose_name="Redelivery Max Date")
    next_dock_due = models.DateTimeField(null=True, blank=True, verbose_name="Next Dock Due")
    ...
    next_dock_shipyard = models.CharField(max_length=50, null=True, blank=True, verbose_name="Next Dock Shipyard")
    built_date = models.CharField(max_length=50, null=True, blank=True, verbose_name="Built Date")
    built_shipyard = models.CharField(max_length=100, null=True, blank=True, verbose_name="Built Shipyard")
...
class TSCost(BaseModel):
    ...
    def __str__(self):
        return f"{self.base_year_month} - {self.port_code} ({self.currency_code}) - {self.full_empty_code} - {self.container_code}"
...
class BunkeringPort(BaseModel):
    ...
    def __str__(self):
        return f"{self.base_year_month} - {self.lane_code} @ {self.bunkering_port} ({self.bunker_type})"
...
class GreenhouseGasTarget(BaseModel):
    ...
    def __str__(self):
        return f"{self.ghg_target_effective_from_year}~{self.ghg_target_effective_to_year}: {self.ghg_target_gco2emj}"