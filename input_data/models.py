...
SCHEDULE_CHANGE_STATUS_CODE_CHOICES = (
    ("A", "Ad hoc Call"), ("I", "Phase In"), ("L", "Vessel Slide"),
    ("O", "Phase Out"), ("S", "Port Omisson"), ("R", "Port Call Swap")
)
...
FIXED_EVENT_TYPE_CHOICES = (
    ("PI", "Phase In"), ("PO", "Phase Out"), ("DD", "Dry Dock"),
    ("OH", "On-Hire"), ("OF", "Off-Hire"), ("LU", "Lay-Up"), ("RA", "Re-Activate")
)
DEPLOYMENT_TYPE_CHOICES = (
    ("I", "Must Go (Include)"), ("E", "Not Allowed (Exclude)"),
    ("P", "Preferred"), ("S", "Substitute")
)
...
class ScenarioInfo(CommonModel):
    id = models.CharField(
        max_length=50, primary_key=True, db_column="scenario_id", verbose_name="Scenario ID"
    )
...
class AbsProformaSchedule(models.Model):
    ...
    actual_work_hours = models.DecimalField(max_digits=5, decimal_places=3, verbose_name="Actual Work Hours",
                                            default=30)
...
class ProformaSchedule(AbsProformaSchedule, ScenarioBaseModel):
    ...
    class Meta:
        ...
        unique_together = (
            ("scenario", "lane_code", "proforma_name", "direction", "port_code", "calling_port_indicator_seq"),)
...
class AbsLongRangeSchedule(models.Model):
    ...
    calling_port_indicator_seq = models.CharField(max_length=2, verbose_name="Calling Port Indicator Seq.")
    calling_port_seq = models.IntegerField(verbose_name="Calling Port Seq.")
    schedule_change_status_code = models.CharField(max_length=1, choices=SCHEDULE_CHANGE_STATUS_CODE_CHOICES, null=True,
                                                   blank=True, verbose_name="Change Status")
    eta_initial_arrival = models.DateTimeField(null=True, blank=True, verbose_name="ETA")
    etb_initial_berthing = models.DateTimeField(null=True, blank=True, verbose_name="ETB")
    etd_initial_departure = models.DateTimeField(null=True, blank=True, verbose_name="ETD")
...
class BaseLongRangeSchedule(AbsLongRangeSchedule):
    ...
    class Meta:
        ...
        unique_together = (
            ("lane_code", "vessel_code", "voyage_number", "direction", "port_code", "calling_port_indicator_seq"),)
...
class TSCost(AbsTSCost, ScenarioBaseModel):
    ...
    class Meta:
        ...
        unique_together = (("scenario", "base_year_month", "port_code", "currency_code"),)
...
class AbsBunkerConsumptionPort(models.Model):
    ...
    base_year_month = models.CharField(max_length=6, verbose_name="Base Year Month")
    nominal_capacity = models.IntegerField(verbose_name="Nominal Capacity")
    port_stay_bunker_consumption = models.DecimalField(max_digits=5, decimal_places=3, verbose_name="Port Stay Consumption")
    idling_bunker_consumption = models.DecimalField(max_digits=5, decimal_places=3, verbose_name="Idling Consumption")
    pilot_inout_bunker_consumption = models.DecimalField(max_digits=5, decimal_places=3, verbose_name="Pilot In/Out Consumption")
...
class AbsFixedVesselDeployment(models.Model):
    ...
    remark = models.CharField(max_length=255, null=True, blank=True, verbose_name="Remark")
...
class FixedVesselDeployment(AbsFixedVesselDeployment, ScenarioBaseModel):
    ...
    def __str__(self):
        ...
        return f"[{self.scenario.id}] {self.lane_code} - {self.vessel_code} ({type_str})"
...
class AbsFixedVesselEvent(models.Model):
    ...
    vessel_code = models.CharField(max_length=20, verbose_name="Vessel Code")
    port_code = models.CharField(max_length=10, verbose_name="Port Code")
    event_type = models.CharField(max_length=2, choices=FIXED_EVENT_TYPE_CHOICES, verbose_name="Event Type")
...
class FixedVesselEvent(AbsFixedVesselEvent, ScenarioBaseModel):
    ...
    class Meta:
        ...
        unique_together = (("scenario", "vessel_code", "port_code", "event_type", "event_date"),)
...
class AbsPortConstraint(models.Model):
    ...
    """
    port_code = models.CharField(max_length=10, verbose_name="Port Code")
    terminal_code = models.CharField(max_length=10, default='All', verbose_name="Terminal Code")
    exclude_vessel_class = models.CharField(max_length=50, null=True, blank=True, verbose_name="Excluded Vessel Class")
