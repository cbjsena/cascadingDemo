...
DROP TABLE IF EXISTS public."std_cost_exchange_rate" CASCADE;
DROP TABLE IF EXISTS public."django_admin_log" CASCADE;
DROP TABLE IF EXISTS public."std_bunker_consumption_port" CASCADE;
DROP TABLE IF EXISTS public."std_bunker_consumption_sea" CASCADE;
DROP TABLE IF EXISTS public."std_bunker_bunker_price" CASCADE;
DROP TABLE IF EXISTS public."std_cost_canal_fee" CASCADE;
DROP TABLE IF EXISTS public."std_vessel_charter_cost" CASCADE;
DROP TABLE IF EXISTS public."std_cost_distance" CASCADE;
DROP TABLE IF EXISTS public."std_constraint_fixed_deployment" CASCADE;
DROP TABLE IF EXISTS public."std_constraint_fixed_event" CASCADE;
DROP TABLE IF EXISTS public."std_schedule_long_range" CASCADE;
DROP TABLE IF EXISTS public."std_constraint_port" CASCADE;
DROP TABLE IF EXISTS public."std_schedule_proforma" CASCADE;
DROP TABLE IF EXISTS public."std_cost_ts_cost" CASCADE;
DROP TABLE IF EXISTS public."std_vessel_capacity" CASCADE;
DROP TABLE IF EXISTS public."std_vessel_info" CASCADE;
DROP TABLE IF EXISTS public."sce_scenario_info" CASCADE;
DROP TABLE IF EXISTS public."sce_schedule_proforma" CASCADE;
DROP TABLE IF EXISTS public."sce_constraint_port" CASCADE;
DROP TABLE IF EXISTS public."sce_schedule_long_range" CASCADE;
DROP TABLE IF EXISTS public."sce_constraint_fixed_event" CASCADE;
DROP TABLE IF EXISTS public."sce_constraint_fixed_deployment" CASCADE;
DROP TABLE IF EXISTS public."sce_cost_exchange_rate" CASCADE;
...
DROP TABLE IF EXISTS public."sce_bunker_bunker_price" CASCADE;
...
DROP TABLE IF EXISTS public."std_week_period" CASCADE;
