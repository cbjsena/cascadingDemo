...
DROP TABLE IF EXISTS public."base_bunker_bunker_price" CASCADE;
...
DROP TABLE IF EXISTS public."base_cost_exchange_rate" CASCADE;
DROP TABLE IF EXISTS public."base_constraint_fixed_deployment" CASCADE;
DROP TABLE IF EXISTS public."base_constraint_fixed_event" CASCADE;
