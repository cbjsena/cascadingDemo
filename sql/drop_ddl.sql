...
DROP TABLE IF EXISTS public."base_schedule_cascading" CASCADE;
DROP TABLE IF EXISTS public."base_schedule_cascading_vessel_position" CASCADE;
...
DROP TABLE IF EXISTS public."master_lane" CASCADE;
DROP TABLE IF EXISTS public."master_port" CASCADE;
DROP TABLE IF EXISTS public."master_trade" CASCADE;
...
DROP TABLE IF EXISTS public."sce_kpi_snapshot" CASCADE;
DROP TABLE IF EXISTS public."sce_lane_proforma_mapping" CASCADE;
DROP TABLE IF EXISTS public."sce_scenario_comparison" CASCADE;
DROP TABLE IF EXISTS public."sce_scenario_comparison_compare_scenarios" CASCADE;
DROP TABLE IF EXISTS public."sce_scenario_info" CASCADE;
DROP TABLE IF EXISTS public."sce_schedule_cascading" CASCADE;
DROP TABLE IF EXISTS public."sce_schedule_cascading_vessel_position" CASCADE;
...
DROP TABLE IF EXISTS public."sce_simulation_run" CASCADE;
