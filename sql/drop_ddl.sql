...
DROP TABLE IF EXISTS public.sce_schedule_cascading CASCADE;
DROP TABLE IF EXISTS public.sce_schedule_cascading_detail CASCADE;
DROP TABLE IF EXISTS public.sce_schedule_proforma_detail CASCADE;
